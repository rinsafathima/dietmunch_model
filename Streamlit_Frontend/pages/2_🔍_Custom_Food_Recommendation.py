...
st.set_page_config(page_title="Custom Food Recommendation", 
                   page_icon="🔍",
                   layout="wide"
                   )

st.title("""🌽 Indulge in Tailored Culinary Delights: 
         Your Personalized Gastronomic Journey 🍽️""")

st.markdown(
    """
    💡 Simply provide us with your 
            nutritional preferences, including fiber content, sodium levels, and more, and we'll curate a personalized meal plan tailored just for you! 🥦🍅
    🍲
      Let our advanced algorithms work their magic and discover a world of delicious recipes perfectly aligned with your dietary goals and preferences. Let's get started on your gastronomic journey to wellness and culinary bliss! 🥗🌱
    """
)
