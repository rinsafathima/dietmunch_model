...
st.title("""🥗 Plan Your Culinary Adventure: 
         Your Personalized Meal Planner 📅""")

st.markdown(
    """
    🎉 Embark on a Personalized Culinary Adventure with Cutting-edge Algorithms and Machine Learning. Whether you're a dedicated foodie craving new culinary experiences or a health-conscious individual in pursuit of dietary enlightenment, our innovative system is here to cater to your every need!
    ...
    Simply provide us with your:
        ...
        And voilà! We'll generate a tailored plan just for you, packed with delicious recipes and expert dietary advice to fuel your journey to wellness and culinary bliss. Let's get cooking! 🥗🍳🥑"
    """
)
